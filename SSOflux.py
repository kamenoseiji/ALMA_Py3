...
#-------- SSO Model
for ssoIndex in list(range(SSONum)):
    for spw_index in list(range(spwNum)): 
...
for ssoIndex in list(range(SSONum)):
    ...
    for spw_index in list(range(spwNum)):
        ...
        for ant0_index in list(range(1, antNum)):
            text_sd = antList[ant0_index] + ' : '; print(text_sd, end='')
        ...
        #
        print('       ', end='')
        for ant0_index in list(range(antNum - 1)):
            print(antList[ant0_index], end=' ')
        #
        print('')
    #
#
